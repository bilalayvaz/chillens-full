  ...
  <>
    ...
    <main className="container">
      ...
      <div className="text-center mb-8">
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-9 justify-between">
          <p className="text-gray-700 flex-1 text-center md:text-right text-lg md:text-3xl md:max-w-sm pl-0 md:pl-8">
            <span className="text-red-500">GM</span>, Lensfrens! are you bored?{' '}
            <span className="text-red-500">click</span> this button now to
          </p>
          <button 
            className="border border-black px-4 py-4 text-red-400 text-3xl md:text-6xl leading-tight hover:bg-[#ff3131] hover:bg-opacity-10 transition-colors"
            onClick={handleShareClick}
          >
            {/* Mobilde tek satır, desktop'ta iki satır */}
            <span className="text-red-500 block">SHARE </span>
            <span className="text-red-500 block">SOMETHING</span>
          </button>
          <p className="text-gray-700 flex-1 text-center md:text-left text-lg md:text-3xl md:max-w-sm pr-0 md:pr-8">
